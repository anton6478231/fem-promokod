...
def read_params(scenario: str = "base") -> Dict[str, Any]:
    ...
    if scenario == "base":
        ...
        params["tid_enabled"] = False
        params["tid_auth_share_pct"] = 0.0
        params["tid_repeat_lift_pct"] = 0.0
        params["tid_cpa_lift_pct"] = 0.0
        params["tid_card_lift_pct"] = 0.0
        params["onsite_ads_enabled"] = False
        params["onsite_ad_impressions"] = 0
        params["onsite_ad_fill_pct"] = 0
        params["onsite_ad_ecpm"] = 0
        params["bank_enabled"] = False
        params["debit_show_pct"] = 0
        params["debit_util_pct"] = 0
        params["debit_inc_pct"] = 0
        params["credit_show_pct"] = 0
        params["credit_util_pct"] = 0
        params["credit_inc_pct"] = 0
        params["stretch_extra_traffic"] = 0
        params["distribution_cost"] = 0
        params["coverage_start_pct"] = 100.0
        params["coverage_target_pct"] = 100.0
        params["mon_start_pct"] = 100.0
        params["mon_target_pct"] = 100.0
        return params
